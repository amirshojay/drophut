...
?>
      ...
      <form action="admin.upload.php" method="POST"  class="needs-validation"  enctype="multipart/form-data" novalidate style="margin-top:100px">
          ...
          <div class="container mt-3 p-3" style="width:50vw;border: 2px solid black;border-radius:5px;box-sizing:border-box;">
            <h1 style="margin-bottom:1rem">Add new product</h1>
        ...
        <div class="invalid-feedback">Please fill out this field.</div>
          ...
          <div class="form-group">
          <input type="text" name="product_name" placeholder="Enter product's name" class="form-control" required>
          <div class="valid-feedback">Valid.</div>
        <div class="invalid-feedback">Please fill out this field.</div>
          </div>
          <div class="form-group">
          <input type="text" name="product_price" placeholder="Enter product's price" class="form-control" required>
          <div class="valid-feedback">Valid.</div>
        <div class="invalid-feedback">Please fill out this field.</div>
          </div>
          <div class="form-group">
    ...
    <div class="invalid-feedback">Please fill out this field.</div>
          ...
          <button type="submit" name="submit_add" class="btn btn-primary btn-lg" required>Add product</button>
          </div>
      </form>
      <script>
